...
namespace question_1
{
    ...
    {
        private const string ConnectionString = @"Server=DESKTOP-8IHO1V4\SQLEXPRESS;Database=final;Trusted_Connection=True;";
        ...
        private void LoadQuestions()
        {
            ...
            {
                MessageBox.Show($"An error occurred while loading questions: {ex.Message}", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            finally
            {
